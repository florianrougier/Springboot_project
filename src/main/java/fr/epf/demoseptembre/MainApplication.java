...
public class MainApplication {
    ...
    public void init() {
        ...
        storyDao.deleteAll();
        storyDao.save(new Story(null, "John Wars", "La vie de John allait bien jusqu'a que son chimpanzé domestique se fasse tué par un gang de mafieux. Il décide alors de se venger !!!", userDao.findByLogin("tibo").get(0), "img/seigneur_des_moineaux.jpg"));
        storyDao.save(new Story(null, "Le seigneur des moineaux", "Gollum la mouette se retrouve un jour foudroyé par l'amour, en rencontrant un moineau nommé 'Gisèle'. Arriverez vous à la convaincre de votre amour passionné ???", userDao.findByLogin("alex").get(0), "img/seigneur_des_moineaux.jpg"));
